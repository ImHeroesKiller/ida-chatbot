...
export function LandingChatMockup() {
  return (
    <figure className="relative mx-auto w-full max-w-md">
      <div
        className="relative overflow-hidden rounded-[1.75rem] border border-border/60 bg-[#F5F5F7] shadow-2xl shadow-primary/10 dark:bg-[#1C1C1E]"
        aria-hidden
      >
      ...
      <figcaption className="sr-only">
        Pratinjau kolom chat IDA dengan bubble pesan dan composer.
      </figcaption>
    </figure>
  );
}